...
var scenario = new ScenarioContext { ScenarioId = "benchmark", Criteria = criteria };
...
var report = RenderReport(rows, provider.Name, model, pricing);
...
string RenderReport(List<Row> rs, string prov, string mdl, (string Model, double In, double Out)[] price)
{
